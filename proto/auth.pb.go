...
const file_proto_auth_proto_rawDesc = "" +
	...
	"\tproviders\x18\x01 \x03(\tR\tproviders\"X\n" +
	...
	"\x05total\x18\x02 \x01(\x05R\x05total2\xe1\x06\n" +
	"\vAuthService\x129\n" +
	...
	"\x11GetLinkedAccounts\x12\x1e.auth.GetLinkedAccountsRequest\x1a\x1f.auth.GetLinkedAccountsResponse\x12B\n" +
	"\vSearchUsers\x12\x18.auth.SearchUsersRequest\x1a\x19.auth.SearchUsersResponseB&Z$github.com/study-platform/proto/authb\x06proto3"
...
var file_proto_auth_proto_depIdxs = []int32{
	...
	25, // 1: auth.User.updated_at:type_name -> google.protobuf.Timestamp
	...
	0,  // 6: auth.SearchUsersResponse.users:type_name -> auth.User
	...
	23, // 18: auth.AuthService.SearchUsers:input_type -> auth.SearchUsersRequest
	...
	24, // 30: auth.AuthService.SearchUsers:output_type -> auth.SearchUsersResponse

...
func (rt *Router) SetupRoutes() *mux.Router {
	...
	authRoutes.HandleFunc("/verify-email", rt.authHandler.VerifyEmail).Methods("POST")
	authRoutes.HandleFunc("/resend-verification", rt.authHandler.ResendVerification).Methods("POST")
	authRoutes.HandleFunc("/verify/{token}", rt.authHandler.VerifyEmailToken).Methods("GET")

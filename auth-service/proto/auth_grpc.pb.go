...
type AuthServiceClient interface {
	...
	VerifyEmailToken(ctx context.Context, in *VerifyTokenRequest, opts ...grpc.CallOption) (*VerifyEmailResponse, error)
}
...
func (c *authServiceClient) VerifyEmailToken(ctx context.Context, in *VerifyTokenRequest, opts ...grpc.CallOption) (*VerifyEmailResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VerifyEmailResponse)
	err := c.cc.Invoke(ctx, AuthService_VerifyEmailToken_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	VerifyEmailToken(context.Context, *VerifyTokenRequest) (*VerifyEmailResponse, error)
...
func (UnimplementedAuthServiceServer) VerifyEmailToken(context.Context, *VerifyTokenRequest) (*VerifyEmailResponse, error) {
...
func _AuthService_VerifyEmailToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).VerifyEmailToken(ctx, req.(*VerifyTokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}
